...
namespace Phinanze.Forms
{
    public partial class CategoryListForm : Form
    {
        ...
        private void ThisFormLoading(object sender, EventArgs e)
        {
            ...
            {
                foreach (string category in GlobalSettings.ExpenseCategories)
                {
            ...
            {
                foreach (string category in GlobalSettings.EarningCategories)
                {
                    CategoryDataGridView.Rows.Add(category);
                }
        ...
        private void DataGridViewCellEditEnded(object sender, DataGridViewCellEventArgs e)
        {
            ...
            foreach (string categoryName in _categoryType == "Expense" ?
                GlobalSettings.ExpenseCategories : GlobalSettings.EarningCategories)
            {
        ...
        private void UpdateCategories()
        {
            ...
            {
                GlobalSettings.ExpenseCategories.Clear();
                ...
                foreach (DataGridViewRow row in CategoryDataGridView.Rows)
                {
                    if (!IsLastEmptyRow(row.Index))
                    {
                        ...
                        GlobalSettings.ExpenseCategories.Add(category);
            ...
            {
                GlobalSettings.EarningCategories.Clear();
                ...
                foreach (DataGridViewRow row in CategoryDataGridView.Rows)
                {
                    ...
                    {
                        category = FilterString(row.Cells[0].Value.ToString());
                        GlobalSettings.EarningCategories.Add(category);
                        categoryNames += category;
